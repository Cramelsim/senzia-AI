...
const NAV_MANAGEMENT = [
  ...
  { label: 'Settings', icon: SettingsIcon, to: '/settings', active: true },
    ...
    <div className="senzia-app">
      ...
      <aside className="sidebar">
        ...
        <nav className="nav-section">
          ...
          {NAV_MANAGEMENT.map(({ label, icon: Icon, to, active }) => (
            <Link key={label} to={to} className={`nav-link${active ? ' active' : ''}`}>
              <Icon size={17} />
              {label}
            </Link>
          ))}
      ...
      <div className="main-col">
        ...
        <div className="page-body">
          ...
          <div className="page-header">
            <div className="page-header-icon"><SettingsIcon size={22} /></div>
            <div>
            ...
            <div className="content-stack">
              ...
              {activeTab === 'data' && (
                <div className="form-section">
                  ...
                  <div className="field-block danger-card" style={{ background: 'var(--surface)', border: '1px solid rgba(239,90,90,0.25)', borderRadius: 'var(--radius-lg)', padding: '1.1rem' }}>
                    <h4 style={{ fontSize: '1.05rem', margin: '0 0 0.3rem' }}>Danger Zone</h4>
          ...
          {/* Need help footer strip (kept from original, restyled) */}
