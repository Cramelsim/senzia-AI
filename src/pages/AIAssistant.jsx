  ...
  return (
    <div style={{ background: '#f8f9fa', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>Ask questions and get instant business insights.</p>
        ...
        <div style={{ 
          ...
          <h2 style={{ color: '#1a1a1a', marginBottom: '0.5rem' }}>AI Assistant Coming Soon</h2>
